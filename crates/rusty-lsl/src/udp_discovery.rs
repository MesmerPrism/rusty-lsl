...
mod tests {
    ...
    fn lslc_006b_response_for(query_id: u64) -> Vec<u8> {
    ...
    #[test]
    fn lslc_006b_receive_order_identity_ownership_and_caller_port_cleanup() {
        ...
        let first_bytes = lslc_006b_response_for(17);
        let second_bytes = lslc_006b_response_for(29);
    ...
    #[test]
    fn lslc_006b_pre_cancel_precedes_socket_and_response_limit_work() {
