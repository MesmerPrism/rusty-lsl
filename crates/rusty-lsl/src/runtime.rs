...
pub use crate::{
    ...
    TypedUdpDiscoveryFloat32SessionConnectionError, UdpDiscoveryActivation,
    UdpDiscoveryActivationError, UdpDiscoveryConfig, UdpDiscoveryError, UdpDiscoveryLimitError,
